...
```mermaid
graph TD
    A[1. Introduction<br/>Purpose & consent] --> B[2. Screening<br/>Eligibility questions]
    B --> C[3. Warm-up<br/>Easy questions]
    C --> D[4. Main Content<br/>Key questions]
    D --> E[5. Demographics<br/>Background info]
    E --> F[6. Thank You<br/>Completion]
