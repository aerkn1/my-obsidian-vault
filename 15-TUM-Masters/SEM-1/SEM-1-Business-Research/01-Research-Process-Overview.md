...
```mermaid
graph TB
    A[1. Research Question/<br/>Problem] --> B[2. Literature Review]
    B --> C[3. Theory Development]
    C --> D[4. Research Design]
    D --> E[5. Data Collection]
    E --> F[6. Data Analysis]
    F --> G[7. Interpretation]
    G --> H[8. Dissemination]
...
```mermaid
graph LR
    A[Research Questions] --> B[Descriptive]
    A --> C[Correlational]
    A --> D[Causal]
    A --> E[Exploratory]
    
    B --> B1["What is X?<br/>How much?"]
    C --> C1["Are X and Y<br/>related?"]
    D --> D1["Does X<br/>cause Y?"]
    E --> E1["What's going<br/>on here?"]
